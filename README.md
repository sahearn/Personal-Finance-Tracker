...
### Spending Reports
Enough with the manual processes! Once the initial imports are done, everything on the dashboard beyond the "Overview" section is immediately updated and viewable.  This includes the following:
